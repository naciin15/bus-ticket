...
<head>
    ...
    <title>Manage Users - LineBus Admin</title>
                ...
                <form method="GET" class="filter-form">
                    ...
                    <div class="filter-group">
                        ...
                        <input type="text" id="search" name="search" class="form-control" 
                               value="<?= htmlspecialchars($search) ?>" placeholder="Username, Email, Name">
                    </div>
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <?php foreach ($users as $user): ?>
                            <tr>
                                <td>
                                    <div class="user-info"><?= htmlspecialchars($user['username']) ?></div>
                                ...
                                <td>
                                    <div style="display: flex; gap: 0.5rem;">
                                        <a href="user_details.php?id=<?= $user['id'] ?>" class="action-btn view">
                                            <i class="fas fa-eye"></i> View
                                        </a>
                                        <?php if ($admin_role === 'super_admin' || $admin_role === 'admin'): ?>
                                            <a href="edit_user.php?id=<?= $user['id'] ?>" class="action-btn edit">
